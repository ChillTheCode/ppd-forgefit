...
const PersetujuanKepalaSDM = () => {
  ...
  useEffect(() => {
    ...
    useEffect(() => {
      if (roleUser && roleUser !== "Kepala Departemen SDM dan Umum" && roleUser !== "Staf Gudang Pelaksana Umum") {
        navigate("/");
      }
    }, [roleUser, navigate]);
  ...
  const handleSetuju = async () => {
    try {
      ...
      const response = await pengadaanpusat.persetujuanKepalaDepartemen(
  ...
  return (
    <div className="flex flex-col pb-10">
      <h1 className="py-5 ps-5">
        {roleUser === "Staf Gudang Pelaksana Umum" ? "Informasi Pengajuan" : "Persetujuan Kepala SDM dan Umum"}
      </h1>
      <DataTable
        value={products}
...
export default PersetujuanKepalaSDM;
