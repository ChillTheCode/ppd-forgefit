...
const PersetujuanKepalaSDMCKS = () => {
  ...
  const handleSetuju = async () => {
    try {
      ...
      const response = await pengadaanCKSservice.persetujuanKepalaDepartemen(
        accessToken,
        idPengajuan,
        true,
        nomorCabang,
    ...
    <div className="flex flex-col pb-10">
      ...
      {roleUser === "Kepala Departemen SDM dan Umum" && (
              <div className="flex space-x-2">
                 ...
                 {step == 1 ? (
                  <div>
                    ...
                    <Button
                      ...
                      disabled={isApprovalBlockedDueToStock} // Disable if approval is blocked
                      data-pr-tooltip="Tidak bisa ditolak karena stok pusat tidak mencukupi untuk beberapa item"
                      data-pr-position="top"
                    />
                  </div>
                ) 
                ...
                <Button
                  label="Tambah Keterangan" // Changed label slightly for clarity
                  icon="pi pi-pencil"
                  onClick={tambahKomentar} // Use the new handler
                  className="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600"
                  // This button is generally always enabled, but logic is inside handleRevisi
                />
              </div>
            )}
            <div className="mt-6 border-t border-gray-200 pt-6">
...
export default PersetujuanKepalaSDMCKS;
