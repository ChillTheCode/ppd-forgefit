...
const PersetujuanStafKeuanganCKS = () => {
  ...
  const handleSetuju = async () => {
    try {
      ...
      const response = await pengadaanCKSservice.persetujuanStafKeuangan(
        accessToken,
        idPengajuan,
        true,
        nomorCabang,
  ...
  return (
    <div className="flex flex-col pb-10">
      <h1 className="py-5 ps-5">
        {roleUser === "Staf keuangan"
          ? "Persetujuan Staf Keuangan"
          : "Informasi Pengajuan"}
      </h1>
...
export default PersetujuanStafKeuanganCKS;
