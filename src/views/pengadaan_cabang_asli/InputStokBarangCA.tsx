...
const InputStokBarangCA = () => {
  ...
  useEffect(() => {
    ...
    const fetchBarang = async () => {
      try {
        ...
        const response = await pengadaanCAservice.getBarang(nomorCabang);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await pengadaanCAservice.AddStockService(
        accessToken,
          ...
          <>
            <div className="bg-white p-6 rounded-xl shadow-md   space-y-4">
              <h2 className="text-2xl font-bold text-gray-800">
                Form Input Stok Barang Cabang Asli
              </h2>
...
export default InputStokBarangCA;
